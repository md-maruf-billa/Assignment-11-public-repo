    ...
    return (
        <div className='min-h-screen flex justify-center items-center'>
            <div class="w-full max-w-sm md:max-w-lg p-6 m-auto mx-auto bg-white rounded-lg shadow-md dark:bg-gray-800 border border-green-500">
                ...
                <form class="mt-2">
                    <div>
                        <label for="username" class="block text-sm text-gray-800 dark:text-gray-200">E-mail</label>
                        <input 
                        type="text" 
                        ...
                        placeholder='E-mail or user name' required
                        />
                    </div>
                    ...
                    <div class="mt-6">
                        <div class="flex items-center justify-between">
                            ...
                            <Link class="text-xs text-green-500 dark:text-green-400 hover:underline">Forget Password?</Link>
                        </div>
                ...
                <p class="mt-8 text-xs font-light text-center text-gray-400"> Don't have an account? <Link to={"/registration"} class="font-medium text-green-600 dark:text-green-500 hover:underline">Create One</Link></p>
            </div>
        </div>
    );
};
