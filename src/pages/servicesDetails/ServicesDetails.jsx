            ...
            <div className="bg-white dark:bg-gray-900 mt-20">
                ...
                <div className="container px-6 py-8 mx-auto">
                    <div className="flex flex-col items-center justify-center space-y-8 lg:-mx-4 lg:flex-row lg:items-stretch lg:space-y-0">
                        <div className="flex flex-col cursor-not-allowed w-full max-w-sm p-8 space-y-8 text-center bg-white border-2 border-gray-200 rounded-lg lg:mx-4 dark:bg-gray-900 dark:border-gray-700">
                        ...
                        <div className="flex flex-col w-full max-w-sm p-8 space-y-8 text-center bg-white border-2 hover:border-green-500 border-gray-200 rounded-lg lg:mx-4 dark:bg-gray-900 dark:border-gray-700">
                            <div className="flex-shrink-0">
                                <h2 className="inline-flex items-center justify-center px-2 font-semibold tracking-tight text-green-500 uppercase rounded-lg bg-gray-50 dark:bg-gray-700">
                                    Expert
                                </h2>
